...
import fastcampus.part.chapter4.databinding.ActivityEditBinding
...
class EditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //values에 array.xml 파일에 혈액형 내용 넣음.
